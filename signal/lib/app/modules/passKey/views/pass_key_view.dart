...
class PassKeyView extends GetView<PassKeyController> {
   PassKeyView({super.key});
  final GlobalKey<FormState> _passKeyFormKey = GlobalKey<FormState>();
  @override
              ...
              Stack(
                children: [
                  ...
                  Container(
                      ...
                      child: Text(
                          appLocalization!.provide_pass_key,
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        onSaved: (value) {
                          //controller.passKey.value = value!;
                        },
                        validator: (value) {
                    ...
                    (controller.isLoading.value == true)
                        ...
                        : ElevatedButton(
                      onPressed: () {
                        controller.connect(context, _passKeyFormKey);
                      },
